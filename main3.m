...
linesgraphic = findallLinesflowchart(graphic,realcontours);       %连接线层
...
[seperateLinesGraphics,ids,jointpoints,linewidth]=LinesFromJointpointLinesForflowchart(everylines);%找到含有分支点的连接线以及对应编号id，将分支点断开
